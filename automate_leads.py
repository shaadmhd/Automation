...
YOUR_MOBILE_NUMBER = "Enter your Number"  # <--- REPLACE with your actual mobile number
YOUR_PASSWORD = "Enter your password"       # <--- REPLACE with your actual password
...
def initialize_driver():
    ...
    try:
        ...
        print("Also, check your internet connection or firewall settings.")
        print("If issues persist, try manually downloading the EdgeDriver from Microsoft's site and placing it in a known PATH, or try clearing the webdriver-manager cache.")
        return None
...
def set_date_picker_to_next_day(driver, date_input_locator):
    ...
    try:
        ...
        tomorrow_str = tomorrow.strftime("%Y-%m-%d") # Format for input type="date" (e.g., 2025-06-24)
